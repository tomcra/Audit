/**
 * Created by tcradd01 on 30/10/2015.
 */
...
var imageUrl = 'http://localhost:63342/Audit/Client/web/levelx.svg';
L.imageOverlay(imageUrl, imageBounds).addTo(map);

var markerLatLng = L.latLng(40.73,-74.17);

L.marker(markerLatLng,{draggable: true}).addTo(map) ;

var elePosText = document.getElementById("posText");
elePosText.innerHTML = '<p>This is a test</p>';

/*
 This is a button example it was originally copied from
